...
public class AESUtils {
    ...
    public static void main(String[] args) {
        String secretKey = "lewp_pass_123456";
        String text = "kunda_mendian";
        ...
        //System.out.println("明文为：" + RandomStringUtils.randomAlphanumeric(16,32));
        System.out.println(DigestUtils.md5DigestAsHex("33".getBytes()).substring(0,16).length());
        System.out.println("http:/ww".startsWith("http://"));
    }
}
