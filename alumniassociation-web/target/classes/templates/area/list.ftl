...
<#include "../resource.ftl"/>
    <script type="text/javascript" src="/yzweb/area/js/list.js"></script>
</head>
<body>
...
<@shiro.hasPermission name="area:save">
    <button class="layui-btn" onclick="add('/yzweb/area/add')">
        <i class="fa fa-plus">&nbsp;</i>增加
    </button>
</@shiro.hasPermission>

<@shiro.hasPermission name="area:update">
    <button class="layui-btn" onclick="edit('AreaTable','/yzweb/area/edit')">
...
<@shiro.hasPermission name="area:delete">
    ...
    <button class="layui-btn" onclick="deleteBatch('AreaTable','/yzweb/area/delete');">
        <i class="fa fa-trash-o">&nbsp;</i>删除
    </button>
</@shiro.hasPermission>

    <button class="layui-btn" onclick="enable('AreaTable','/yzweb/area/enable')">
        <i class="fa fa-check-square-o">&nbsp;</i>启用
    </button>
    <button class="layui-btn  layui-btn-danger" onclick="limit('AreaTable','/yzweb/area/limit')">
...
<div class="layui-form ">
    <table class="layui-table" id="AreaTable" cyType="pageGrid"
           cyProps="url:'/yzweb/area/listData',checkbox:'true',pageColor:'#2991d9'">
        <thead>
        <tr>
            <!--复选框-->
