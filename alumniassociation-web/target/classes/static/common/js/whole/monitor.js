...
$(function () {
    ...
    //图片点击放大
    $(".layui-upload-list1").on("click","img",function () {
    ...
    $(".layui-upload-list").on("click","img",function () {
        ...
        parent.layer.open({
            ...
            shade: [0.3, '#000'],      //遮罩
            maxmin: false,              //开启最大化最小化按钮
            area: [ data['height']+'px',data['width']+'px'],
            content: '<img src="'+data['dataURL']+'">'
        });
    });
    ...
    function getBase64Image(img) {
        ...
        if(img.height>500&&img.height>0){
           var bit = 500/img.height;
           img.height = img.height*bit;
           img.width = img.width*bit;
        }
        ...
        var data ={'dataURL':dataURL,'height':canvas.width,'width':canvas.height};
        return data
    }
});
