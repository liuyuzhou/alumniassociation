...
public class LoginMock {
    ...
    public DataMsg loginByWeixin(@RequestBody WxLoginInfo wxLoginInfo, com.alumniassociation.api.common.xss.XssHttpServletRequestWrapper request) {
        wxLoginInfo=new WxLoginInfo();
        wxLoginInfo.setCode(UUID.randomUUID()+"");
        wxLoginInfo.setUserInfo(new com.alumniassociation.api.dto.UserInfo().setNickName("江理小星").setGender((byte) 1).setAvatarUrl("/mock/pic"));
