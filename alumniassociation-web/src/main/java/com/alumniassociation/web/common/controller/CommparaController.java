...
public class CommparaController extends AbstractController{
    ...
    public R getCodeValue(@RequestParam Map<String, Object> params){
        List<Commpara> commparaList = commparaService.queryList(params);
        return R.ok().put("data", commparaList);
    }
}
