...
<div class="layui-field-box">
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-normal">
                <input value="${(model.parentId)!""}" id="parent"
                       cyType="treeTool" cyProps="url:'/yzweb/sys/menu/select',name:'parentId'"
        ...
        <div class="page-footer">
            <div class="btn-list">
                <div class="btnlist">
                    <button class="layui-btn" lay-submit="" lay-filter="submit" data-url="/yzweb/sys/menu/update"><i class="fa fa-floppy-o">&nbsp;</i>保存</button>
