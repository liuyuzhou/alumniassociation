...
<div class="layui-field-box">
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">审核意见<span class="span_must">*</span></label>
            <div class="layui-input-block">
                <textarea  name="remark" maxlength="150" lay-verify="required"
                   placeholder="请输入审核意见"  class="layui-textarea">${(model.remark)!""}</textarea>
            </div>
        </div>
...
<script>
    ...
    $.ajax({
        type: "post",
        url: '/yzweb/sys/role/info/${model.roleId}',
        contentType: "application/json",
        async: false,
        dataType: "json",
        success: function (R) {
