    ...
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline" style="width:700px;">
                <div cyType="linkSelectTool" cyProps="url:'/yzweb/area/normalList/',topId:'0000000000',name:'parentAreaIds[]'"
        ...
        <div class="page-footer">
            <div class="btn-list">
                <div class="btnlist">
                    <button class="layui-btn" lay-submit="" lay-filter="submit" data-url="/yzweb/area/save"><i class="fa fa-floppy-o">&nbsp;</i>保存</button>
