package com.alumniassociation.report.jasperreports;
...
public class JasperHelper {
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public static void showPdf(String defaultFilename, InputStream input,
            HttpServletRequest request, HttpServletResponse response, Map parameters,
            JRDataSource conn) throws JRException, IOException {
        ...
        JasperPrint jasperPrint = JasperFillManager.fillReport(input,
                parameters, conn);
        request.getSession().setAttribute(
                ImageServlet.DEFAULT_JASPER_PRINT_SESSION_ATTRIBUTE,
                jasperPrint);
