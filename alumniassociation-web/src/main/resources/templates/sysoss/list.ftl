...
<head>
    ...
    <script type="text/javascript" src="/yzweb/sysoss/js/list.js"></script>
</head>
<body>
...
<div class="layui-btn-group">
        ...
        <button class="layui-btn" onclick="addPage('/yzweb/sysoss/add')">
            <i class="fa fa-plus">&nbsp;</i>增加
        </button>
        </@shiro.hasPermission>
        <@shiro.hasPermission name="sysoss:update">
        <button class="layui-btn" onclick="editPage('sysOssTable','/yzweb/sysoss/edit')">
            <i class="fa fa-pencil-square-o">&nbsp;</i>修改
        </button>
         <button class="layui-btn layui-btn-green" onclick="updateState('批量启用','sysOssTable','/yzweb/sysoss/enable')">
            <i class="fa fa-check-square-o">&nbsp;</i>启用
        </button>
        <button class="layui-btn  layui-btn-danger" onclick="updateState('批量禁用','sysOssTable','/yzweb/sysoss/limit')">
            <i class="fa fa-expeditedssl">&nbsp;</i>禁用
        </button>
        </@shiro.hasPermission>
        <@shiro.hasPermission name="sysoss:delete">
         <button class="layui-btn layui-btn-delete" onclick="deleteBatch('批量删除','sysOssTable','/yzweb/sysoss/delete');">
...
<div class="layui-form nowrap">
    <table class="layui-table" id="sysOssTable" cyType="pageGrid"
           cyProps="url:'/yzweb/sysoss/listData',checkbox:'true',pageColor:'#2991d9'">
        <thead>
        <tr>
            <!--复选框-->
