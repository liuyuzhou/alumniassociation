...
<head>
    ...
    <script type="text/javascript" src="/yzweb/user/js/list.js"></script>
</head>
<body>
...
<@shiro.hasPermission name="sys:user:save">
    <button class="layui-btn" onclick="add('/yzweb/sys/user/add')"><i class="fa fa-plus">&nbsp;</i>增加</button>
</@shiro.hasPermission>
<@shiro.hasPermission name="sys:user:update">
    <button class="layui-btn" onclick="edit('userTable','/yzweb/sys/user/edit')" style="margin-left: 5px!important;">
        <i class="fa fa-pencil-square-o">&nbsp;</i>修改
    </button>
</@shiro.hasPermission>
<@shiro.hasPermission name="sys:user:delete">
    <button class="layui-btn" onclick="deleteBatch('userTable','/yzweb/sys/user/delete');" style="margin-left: 5px!important;">
        <i class="fa fa-trash-o">&nbsp;</i>删除
    </button>
</@shiro.hasPermission>
    <button class="layui-btn" onclick="initPassword('userTable','/yzweb/sys/user/initPassword');" style="margin-left: 5px!important;">
