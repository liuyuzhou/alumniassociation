...
<head>
    ...
    <script type="text/javascript" src="/yzweb/menu/js/list.js"></script>
</head>
<body>
<form class="layui-form " action="">
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input value="" id="parent" cyType="treeTool" cyProps="url:'/yzweb/sys/menu/select',name:'parentId'"
...
<@shiro.hasPermission name="sys:menu:save">
    <button class="layui-btn" onclick="add('/yzweb/sys/menu/add')">
        <i class="fa fa-plus">&nbsp;</i>增加
    </button>
</@shiro.hasPermission>

<@shiro.hasPermission name="sys:menu:update">
    <button class="layui-btn" onclick="edit('menuTable','/yzweb/sys/menu/edit')" style="margin-left: 5px!important;">
        <i class="fa fa-pencil-square-o">&nbsp;</i>修改
    </button>
</@shiro.hasPermission>

<@shiro.hasPermission name="sys:menu:delete">
    <button class="layui-btn" onclick="deleteBatch('menuTable','/yzweb/sys/menu/delete');"
...
<div class="layui-form ">
    <table class="layui-table" id="menuTable" cyType="pageGrid"
           cyProps="url:'/yzweb/sys/menu/listData',checkbox:'true',pageColor:'#2991d9'">
        <thead>
        <tr>
            <!--复选框-->
